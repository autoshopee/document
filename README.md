...
{% content-ref url="shopmanager/san-pham/" %}
...
{% content-ref url="shopmanager/tu-dong/" %}
[tu-dong](shopmanager/tu-dong/)
{% endcontent-ref %}

{% content-ref url="shopmanager/nang-cao/" %}
[nang-cao](shopmanager/nang-cao/)
{% endcontent-ref %}

{% content-ref url="shopmanager/shop-admin/" %}
...
{% content-ref url="extension/su-dung/" %}
...
{% content-ref url="autoshopee/sao-chep-da-san/" %}
[sao-chep-da-san](autoshopee/sao-chep-da-san/)
{% endcontent-ref %}

{% content-ref url="autoshopee/thong-bao-don-hang/" %}
